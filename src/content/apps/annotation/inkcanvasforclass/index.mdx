...
import { Aside, Collapse, Label } from 'astro-pure/user'
...
## <Label title="社区版本" /> [InkCanvasForClass Community Edition](https://github.com/InkCanvasForClass/community)
